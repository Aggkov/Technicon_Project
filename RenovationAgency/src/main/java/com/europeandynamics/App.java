    ...
    public static void main(String[] args) {
        ...
        List<PropertyRepairResponse> allRepairsByDate = propertyRepairService
                .findAllRepairsByDate(LocalDateTime.of(2022, 9, 20, 14, 30, 20), LocalDateTime.of(
                        2022, 9, 21, 14, 30, 20), PropertyRepair.class);
...
//
//            List<?> propertiesByVat = propertyService.findPropertiesByOwnerVatNumber("111111115",
//                    Property.class);
//            logger.info("properties by vat: " + propertiesByVat);
//            logger.info("property found: " + propertyService.findById("E91116", Property.class));
//
//		try {
//			Property property = propertyService.create(new PropertyRequest("E91119","Marasliou 20", LocalDate.of(2000, 9, 22), Type.APARTMENT, "111111115"));
...
//                            .address("Mpoumpulinas 30")
//                            .yearOfConstruction(LocalDate.of(1970, 02, 15))
//                            .type(Type.APARTMENT)
...
//
//        try {
//            propertyOwnerService.create(new PropertyOwner("111111120", "Jack", "Jackson",
//                    "Athens", "6999999999",
